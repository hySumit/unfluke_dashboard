    ...
    <div className="bg-[#0f1014] text-white min-h-screen p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="col-span-2 space-y-4">
          <div className="border border-gray-600 w-[700px] glass rounded-[20px] p-4 space-y-4 relative left-[75px] ">
          ...
          <div className="border border-gray-600 glass2 rounded-[20px] p-4 space-y-4 w-[700px] relative left-[75px] h-[360px]">
